...
$string['clientid_help'] = 'The client ID that MTN Africa generated for your application.';
...
$string['secret_help'] = 'Primary key for MTN Africa Collections.';
$string['secret1'] = 'Secondary key';
$string['secret1_help'] = 'Secondary key for MTN Africa Collections';
$string['secretsb'] = 'Sandbox Primary key';
$string['secretsb_help'] = 'Sandbox Primary key for MTN Africa Collections.';
$string['secret1sb'] = 'Sandbox Secondary key';
$string['secret1sb_help'] = 'Sandbox Secondary key for MTN Africa Collections';
